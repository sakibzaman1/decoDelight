        ...
        <div className="hero lg:p-10 font-Roboto">
          <div className="hero-content p-0 flex-col-reverse lg:flex-row-reverse lg:items-center lg:justify-around">
            ...
            >
              <img
                className="w-80"
                src="https://i.ibb.co/hm0c1K3/Deco-Delight-Logo.png"
                alt=""
              />
            ...
            <div
              className="card lg:w-[60%] flex-shrink-0 max-w-lg shadow-2xl "
              
            >
              <form onSubmit={handleSignIn} className="card-body mt-10 lg:mt-0">
                <h1 className="text-5xl text-white font-bold text-center mb-10">
                  <span className="text-amber-700">Sign in</span> <span className="text-black">now!</span>
                </h1>
                ...
                <div className="form-control mt-10">
                  <button className="h-14 hover:scale-110 transition-transform font-semibold w-full bg-gradient-to-r from-amber-950 via-amber-700 to-amber-200 text-white">
                    Sign in
                  </button>
                </div>
                ...
                <div className="flex flex-col justify-between mt-10 mb-6 space-y-6 lg:space-y-0">
                  <button
                    ...
                    className="text-black border-none btn rounded-none bg-transparent hover:rounded-none hover:bg-gray-200 capitalize"
                  >
                    <FcGoogle></FcGoogle>
                    Sign in with Google
                  </button>
