            ...
            <div className="card lg:w-[60%]  flex-shrink-0 max-w-lg shadow-2xl ">
              <form onSubmit={handleRegister} className="card-body mt-10 lg:mt-0">
                <h1 className="text-5xl font-bold text-center mb-10">
                  <span className="text-amber-700">Register</span> <span className="text-black">now!</span>
                </h1>
                ...
                <div className="form-control mt-6">
                  <button
                    ...
                    className={`w-full  font-semibold text-white h-14  ${
                      isDisabled
                        ? "bg-gray-600"
                        : " bg-gradient-to-r from-amber-950 via-amber-700 to-amber-200  hover:scale-110 transition-transform"
                    }`}
                  >
                    Submit
                  </button>
